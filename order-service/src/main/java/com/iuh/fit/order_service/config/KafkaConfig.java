package com.iuh.fit.order_service.config;
...
public class KafkaConfig {
    ...
    public RecordMessageConverter recordMessageConverter() {
        log.info("Configuring Kafka message converter");
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS, 
            "inventory:com.iuh.fit.order_service.dto.InventoryUpdateEvent," + 
            "payment:com.iuh.fit.order_service.dto.PaymentConfirmationEvent"
        );
