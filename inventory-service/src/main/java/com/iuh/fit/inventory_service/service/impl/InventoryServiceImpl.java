...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryDTO getInventoryByProductId(Long productId) {
        ...
        Inventory inventory = inventoryRepository.findByProductId(productId)
                .orElseThrow(() -> new NotFoundException("Không tìm thấy tồn kho cho sản phẩm có ID: " + productId));
    ...
    public void processOrderCreatedEvent(OrderCreatedEvent event) {
        ...
        if (!errors.isEmpty()) {
            ...
            InventoryUpdateEvent updateEvent = InventoryUpdateEvent.builder()
                    ...
                    .success(false)
                    .message("Không thể hoàn thành đơn hàng do thiếu tồn kho: " + String.join(", ", errors))
    ...
    public boolean reduceInventory(Long productId, Integer quantity, Long orderId, String orderNumber) {
        ...
        try {
            Inventory inventory = inventoryRepository.findByProductId(productId)
                    .orElseThrow(() -> new NotFoundException("Không tìm thấy tồn kho cho sản phẩm ID: " + productId));
